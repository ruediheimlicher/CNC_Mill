...
- (float) EndleistenwinkelvonProfil:(NSArray*)profil
{
 ...
 // Oberseite
   ...
   {
      float deltax = [[[profil objectAtIndex:i]objectForKey:@"x"]doubleValue] - [[[profil objectAtIndex:i-1]objectForKey:@"x"]doubleValue];
      float deltay = [[[profil objectAtIndex:i]objectForKey:@"y"]doubleValue] - [[[profil objectAtIndex:i-1]objectForKey:@"y"]doubleValue];
...
//      steigung *= -1;
   ...
   for (i=anfangsindex;i<endindex;i++)
   {
      ...
      float deltax = [[[profil objectAtIndex:[profil count]-1-i-1]objectForKey:@"x"]doubleValue] - [[[profil objectAtIndex:[profil count]-1-i]objectForKey:@"x"]doubleValue];
      float deltay = [[[profil objectAtIndex:[profil count]-1-i-1]objectForKey:@"y"]doubleValue] - [[[profil objectAtIndex:[profil count]-1-i]objectForKey:@"y"]doubleValue];
      float steigung= atanf(deltay/deltax);
//      steigung *= -1;
      steigungu+= steigung;
...
- (NSDictionary*)SteuerdatenVonDic:(NSDictionary*)derDatenDic
{
   ...
   if ([derDatenDic objectForKey:@"code"])
	...
	float zoomfaktor = [[derDatenDic objectForKey:@"zoomfaktor"]doubleValue];
   ...
   for (i=0;i<[ProfilArray count];i++)
	{
		...
		// X-Achse, 
		float tempX = [[[ProfilArray objectAtIndex:i]objectForKey:@"x"]doubleValue];
      ...
      // NSLog(@"tempX: %2.2f ",tempX);
		...
		//Y-Achse
		float tempY = [[[ProfilArray objectAtIndex:i]objectForKey:@"y"]doubleValue];
...
- (NSDictionary*)HolmDicVonPunkt:(NSPoint)Startpunkt mitProfil:(NSArray*)ProfilArray mitProfiltiefe:(int)Profiltiefe mitScale:(int)Scale
{
   ...
   {
      //NSLog(@"i: %d x: %.3f",i,[[[Profil1Array objectAtIndex:i]objectForKey:@"x"]doubleValue]);
      
      // Koord x laeuft auf der Unterseite von 1 an rueckwaerts. pruefen ob immer npch groesser als Holmposition
      if (i>[ProfilArray count]/2 && [[[ProfilArray objectAtIndex:i]objectForKey:@"x"]doubleValue] > Holmposition)
      {
         holmpos = i;
      }
   }
   
   //       NSLog(@"holmpos: %d x: %.3f y: %.3f",holmpos,[[[ProfilArray objectAtIndex:holmpos]objectForKey:@"x"]doubleValue],[[[ProfilArray objectAtIndex:holmpos]objectForKey:@"y"]doubleValue] );
   //        NSLog(@"x0: %.5f x1: %.5f",[[[ProfilArray objectAtIndex:holmpos-2]objectForKey:@"x"]doubleValue],[[[ProfilArray objectAtIndex:holmpos+2]objectForKey:@"x"]doubleValue]);
   //        NSLog(@"y0: %.5f y1: %.5f",[[[ProfilArray objectAtIndex:holmpos-2]objectForKey:@"y"]doubleValue],[[[ProfilArray objectAtIndex:holmpos+2]objectForKey:@"y"]doubleValue]);
   
   // Startpunkte der Diagonalen auf der unteren Profillinie
   NSPoint Startpunktnachvorn = NSMakePoint([[[ProfilArray objectAtIndex:holmpos]objectForKey:@"x"]doubleValue], [[[ProfilArray objectAtIndex:holmpos]objectForKey:@"y"]doubleValue]);
   ...
   while ((holmpos + schritte) < [ProfilArray count] && distanzreal < 8)
   {
      ...
      Startpunktnachhinten = NSMakePoint([[[ProfilArray objectAtIndex:(holmpos + schritte)]objectForKey:@"x"]doubleValue], [[[ProfilArray objectAtIndex:(holmpos + schritte)]objectForKey:@"y"]doubleValue]);
   ...
   float deltay = [[[ProfilArray objectAtIndex:holmposhinten]objectForKey:@"y"]doubleValue]-[[[ProfilArray objectAtIndex:holmposvorn]objectForKey:@"y"]doubleValue]; // index verlaeuft gegen Endleiste zu
   float deltax = [[[ProfilArray objectAtIndex:holmposhinten]objectForKey:@"x"]doubleValue]-[[[ProfilArray objectAtIndex:holmposvorn]objectForKey:@"x"]doubleValue];
  ...
  // NSLog(@"neu: Startpunktnachhinten.x: %.3f Startpunktnachhinten.y: %.5f",Startpunktnachhinten.x,Startpunktnachhinten.y);
   ...
   float holm1lage=[[[ProfilArray objectAtIndex:holmpos]objectForKey:@"x"]doubleValue]*Profiltiefe;
   ...
   {
      NSPoint tempOberseitenpunkt = NSMakePoint([[[ProfilArray objectAtIndex:k]objectForKey:@"x"]doubleValue], [[[ProfilArray objectAtIndex:k]objectForKey:@"y"]doubleValue]);
   ...
   float deltaxh = [[[ProfilArray objectAtIndex:minhintenpos-2]objectForKey:@"x"]doubleValue] - [[[ProfilArray objectAtIndex:minhintenpos]objectForKey:@"x"]doubleValue];
   
   float deltayh = [[[ProfilArray objectAtIndex:minhintenpos-2]objectForKey:@"y"]doubleValue] - [[[ProfilArray objectAtIndex:minhintenpos]objectForKey:@"y"]doubleValue];
   float steigungh = deltayh/deltaxh;

   //Steigung der Profillinie von minvornpos bis 2 Schritte nach vorn:
   float deltaxv = [[[ProfilArray objectAtIndex:minvornpos+2]objectForKey:@"x"]doubleValue] - [[[ProfilArray objectAtIndex:minvornpos]objectForKey:@"x"]doubleValue];
   float deltayv = [[[ProfilArray objectAtIndex:minvornpos+2]objectForKey:@"y"]doubleValue] - [[[ProfilArray objectAtIndex:minvornpos]objectForKey:@"y"]doubleValue];
   ...
   float startX = [[[ProfilArray objectAtIndex:minhintenpos]objectForKey:@"x"]doubleValue];
   startX *= Profiltiefe;
   float startY = [[[ProfilArray objectAtIndex:minhintenpos]objectForKey:@"y"]doubleValue];
   startY *= Profiltiefe;
   ...
   aktuellerindex++;
   float tempX = [[[ProfilArray objectAtIndex:aktuellepos]objectForKey:@"x"]doubleValue];
   ...
   float tempY = [[[ProfilArray objectAtIndex:aktuellepos]objectForKey:@"y"]doubleValue];
   ...
   aktuellerindex++;
   tempX = [[[ProfilArray objectAtIndex:aktuellepos]objectForKey:@"x"]doubleValue];
   ...
   tempY = [[[ProfilArray objectAtIndex:aktuellepos]objectForKey:@"y"]doubleValue];
...
- (NSMutableArray*)addAbbrandVonKoordinaten:(NSArray*)Koordinatentabelle mitAbbrandA:(float)abbrandmassa  mitAbbrandB:(float)abbrandmassb aufSeite:(int)seite von:(int)von bis:(int)bis
{
   ...
   for (i=0; i<[Koordinatentabelle count];i++)
   {
      ...
      if (i>von-1 && i<bis) // Abbrandbereich, von ist 1-basiert
      {
         ...
         float ax = [[[Koordinatentabelle objectAtIndex:i]objectForKey:@"ax"]doubleValue];
         float ay = [[[Koordinatentabelle objectAtIndex:i]objectForKey:@"ay"]doubleValue];
         float bx = [[[Koordinatentabelle objectAtIndex:i]objectForKey:@"bx"]doubleValue];
         float by = [[[Koordinatentabelle objectAtIndex:i]objectForKey:@"by"]doubleValue];
         ...
         {
            nextax = [[[Koordinatentabelle objectAtIndex:i+1]objectForKey:@"ax"]doubleValue];
            nextay = [[[Koordinatentabelle objectAtIndex:i+1]objectForKey:@"ay"]doubleValue];
            nextbx = [[[Koordinatentabelle objectAtIndex:i+1]objectForKey:@"bx"]doubleValue];
            nextby = [[[Koordinatentabelle objectAtIndex:i+1]objectForKey:@"by"]doubleValue];
         }
         
         
         if (i>von) // Schon im Abbrandbereich von: vorherigen Wert lesen
         {
            prevax = [[[Koordinatentabelle objectAtIndex:i-1]objectForKey:@"ax"]doubleValue];
            prevay = [[[Koordinatentabelle objectAtIndex:i-1]objectForKey:@"ay"]doubleValue];
            prevbx = [[[Koordinatentabelle objectAtIndex:i-1]objectForKey:@"bx"]doubleValue];
            prevby = [[[Koordinatentabelle objectAtIndex:i-1]objectForKey:@"by"]doubleValue];
         }
